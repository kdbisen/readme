...
/**
 * Fenergo Token Service - For External Company APIs
 * Handles token fetching, caching, and refresh for Fenergo APIs
 */
@Slf4j
@Service
...
public class FenergoTokenService {
    ...
    @Value("${fenergo.auth.token-service.url:http://fenergo-token-service:8080/oauth/token}")
    private String tokenServiceUrl;
    
    @Value("${fenergo.auth.client-id:fenergo-client}")
    private String clientId;
    
    @Value("${fenergo.auth.client-secret:fenergo-secret}")
    private String clientSecret;
    
    @Value("${fenergo.auth.default-scope:fenergo-api}")
    private String defaultScope;
    
    @Value("${fenergo.auth.cache-enabled:true}")
